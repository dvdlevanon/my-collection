...
type Database interface {
	...
	GetDirectory(ctx context.Context, conds ...any) (*model.Directory, error)
	GetDirectories(ctx context.Context, conds ...any) (*[]model.Directory, error)
	...
	GetItem(ctx context.Context, conds ...any) (*model.Item, error)
	GetItems(ctx context.Context, conds ...any) (*[]model.Item, error)
	...
	GetTagAnnotation(ctx context.Context, conds ...any) (*model.TagAnnotation, error)
	...
	GetTagImageType(ctx context.Context, conds ...any) (*model.TagImageType, error)
	GetTagImageTypes(ctx context.Context, conds ...any) (*[]model.TagImageType, error)
	...
	GetTagCustomCommand(ctx context.Context, conds ...any) (*[]model.TagCustomCommand, error)
	...
	GetTagsWithoutChildren(ctx context.Context, conds ...any) (*[]model.Tag, error)
	GetTags(ctx context.Context, conds ...any) (*[]model.Tag, error)
	...
	RemoveTasks(ctx context.Context, conds ...any) error
	TasksCount(ctx context.Context, query any, conds ...any) (int64, error)
