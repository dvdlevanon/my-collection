...
function TagSpeedDial({ tag, onManageAttributesClicked, onRemoveTagClicked, onManageImageClicked }) {
				...
				tagCustomCommandsQuery.data.map((command) => {
					return (
						<SpeedDialAction
							...
							icon={<img src={command.icon} alt="icon" style={{ width: '24px', height: '24px' }} />}
